    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 16: Probando el Bloque sys-delay-x04\n\nEl tic inicial se retrasa 4 ciclos",
            "readonly": true
          },
          "position": {
            "x": 80,
        ...
        {
          "id": "9b432869-f077-474c-b8a7-0f6ba767de1a",
          "type": "107d1bd04fc500b120d4f82da834dc25a4040bfd",
          "position": {
            "x": 352,
            "y": 376
          },
        ...
        {
          "id": "7df3bcac-3413-4966-8f75-79ddbd4ea626",
        ...
        {
          "id": "7c6b16d1-062f-49f3-85b2-49b5a4148f25",
      ...
      "wires": [
        {
          "source": {
            "block": "9b432869-f077-474c-b8a7-0f6ba767de1a",
        ...
        },
        {
          ...
          "target": {
            "block": "7df3bcac-3413-4966-8f75-79ddbd4ea626",
        ...
        {
          "source": {
            "block": "7c6b16d1-062f-49f3-85b2-49b5a4148f25",
            "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
          },
          "target": {
            "block": "9b432869-f077-474c-b8a7-0f6ba767de1a",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "0d2893a2-361d-411c-9a42-6bc11222b1ae",
              "type": "basic.inputLabel",
              "data": {
                "name": "n",
                "range": "[1:0]",
            ...
            {
              "id": "72ffc08f-df9a-41fb-a361-86fe03d072ad",
              "type": "basic.outputLabel",
              "data": {
                "name": "n",
                "range": "[1:0]",
            ...
            {
              "id": "fdf9a236-84ad-4faf-842b-1b794e5e296f",
              "type": "basic.output",
              "data": {
                "name": "n",
                "range": "[1:0]",
            ...
            },
            {
              ...
              "type": "basic.info",
              "data": {
                "info": "Current working cycle: 0-3",
                "readonly": true
              },
              "position": {
                "x": 1400,
            ...
            {
              "id": "d78be6bb-08d5-4800-830e-13c6a3ad4437",
            ...
            {
              "id": "d4b6ff26-7a27-468b-a892-71b1a2201e70",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "d4b6ff26-7a27-468b-a892-71b1a2201e70",
                "port": "adf3a6ae-71e2-43dd-b504-c2cdbc14dab7"
              }
            },
            {
            ...
            },
            {
              ...
              "target": {
                "block": "d78be6bb-08d5-4800-830e-13c6a3ad4437",
            ...
            {
              "source": {
                "block": "72ffc08f-df9a-41fb-a361-86fe03d072ad",
                "port": "outlabel"
              },
              "target": {
                "block": "fdf9a236-84ad-4faf-842b-1b794e5e296f",
                "port": "in",
                "size": 2
              },
              "size": 2
